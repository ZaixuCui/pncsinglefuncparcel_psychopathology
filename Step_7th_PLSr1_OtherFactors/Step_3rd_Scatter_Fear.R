...
ggsave('/Users/zaixucui/Dropbox/Paper_Writing_Postdoc/pncSingleParcellation_Psychopathology_PLSR/Figures/Figure8_FearFactor/FearFactorPrediction_CorrACC.tiff', width = 16, height = 15, dpi = 600, units = "cm");
