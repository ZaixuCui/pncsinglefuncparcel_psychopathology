...
ParcellationFolder = [ProjectFolder '/Replication/results/SingleParcellation'];

Parcellation_17_Path = [ParcellationFolder '/SingleAtlas_Analysis/Group_AtlasLabel.mat'];
